...
const mockSkillSearchPrefetchModule = () => ({
...
mock.module('../../skillSearch/prefetch.js', mockSkillSearchPrefetchModule)
mock.module('src/services/skillSearch/prefetch.js', mockSkillSearchPrefetchModule)

const mockGetToolIndex = mock(() => Promise.resolve([] as never[]))
const mockSearchTools = mock(() => [] as never[])

const mockToolIndexModule = () => ({
...
mock.module('../toolIndex.js', mockToolIndexModule)
mock.module('src/services/searchExtraTools/toolIndex.js', mockToolIndexModule)
